    ...
    return (
        <div>
            <div className='p-4 mb-8'>
                <h3 className="text-xl font-semibold mb-3 text-center md:text-left">Login With</h3>
                <div className='mb-3'>
                    <button className="btn btn-outline w-full text-[#588ed8] hover:bg-gray-400 hover:border-none">
                        <FaGoogle className='text-2xl text-[#588ed8]'></FaGoogle>
                        Login With Google
                    </button>
                </div>
                <div>
                    <button className="btn btn-outline w-full text-black hover:bg-gray-400 hover:border-none">
            ...
            <div className='p-4 '>
                <h3 className="text-xl font-semibold mb-5 text-center md:text-left">Find Us On</h3>
                <a className='flex items-center gap-3 p-4 border rounded-t-lg hover:bg-gray-400 hover:border-none justify-center md:justify-start' href="">
                    ...
                    </svg><span className='text-[#706F6F] font-medium'>Facebook</span>
                </a>
                <a className='flex items-center gap-3 p-4 border-x hover:bg-gray-400 hover:border-none justify-center md:justify-start' href="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                        <rect width="30" height="30" rx="15" fill="#F3F3F3" />
                    ...
                    </svg><span className='text-[#706F6F] font-medium'>Twitter</span>
                </a>
                <a className='flex items-center gap-3 p-4 border rounded-b-lg hover:bg-gray-400 hover:border-none justify-center md:justify-start' href="">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                        <rect width="30" height="30" rx="15" fill="#F3F3F3" />
                    ...
                    </svg><span className='text-[#706F6F] font-medium'>Instagram</span>
                </a>
            </div>

            <div className='p-4 mb-7'>
                <h3 className="text-xl font-semibold mb-8 text-center md:text-left">Q-Zone</h3>
